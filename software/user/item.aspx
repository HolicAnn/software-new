                ...
                <div class="body-wrap">
                    <asp:Table ID="table2" BorderWidth="1" CellPadding="3" CellSpacing="3" GridLines="Both" runat="server">
                        <asp:TableRow>
                            ...
                            <asp:TableCell Text="项目名称" Style="background-color: darkgrey" />
                            <asp:TableCell Text="项目类型" Style="background-color: darkgrey" />
                            <asp:TableCell Text="项目介绍" Style="background-color: darkgrey" />
                            <asp:TableCell Text="项目技能" Style="background-color: darkgrey" />
                            <asp:TableCell Text="负责人员" Style="background-color: darkgrey" />
                            <asp:TableCell Text="起始日期" Style="background-color: darkgrey" />
                            <asp:TableCell Text="结束日期" Style="background-color: darkgrey" />
                            <asp:TableCell Text="项目状态" Style="background-color: darkgrey" />
                            <asp:TableCell Text="交付状态" Style="background-color: darkgrey" />
                        </asp:TableRow>
                    </asp:Table>
