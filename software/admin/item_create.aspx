<%@ Page Language="C#" AutoEventWireup="true" CodeFile="item_create.aspx.cs" Inherits="admin_item_create" %>
    ...
    <form id="form1" runat="server">
        <div class="body1">
            ...
            <div class="body1-rigth">
                <div class="header">
                    <span class="header-left-title">项目管理>新建</span>
                    <div class="right">
                ...
                <div class="wrap">
                    ...
                    <div class="input-item">
                        ...
                        <asp:DropDownList ID="item_skill" runat="server" OnSelectedIndexChanged="item_skill_SelectedIndexChanged">
                            <asp:ListItem> </asp:ListItem>
                    ...
                    <div class="input-item">
                        ...
                        <asp:DropDownList ID="item_user" runat="server" OnSelectedIndexChanged="item_user_SelectedIndexChanged">
                            <asp:ListItem> </asp:ListItem>
