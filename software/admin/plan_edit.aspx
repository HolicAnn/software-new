<%@ Page Language="C#" AutoEventWireup="true" CodeFile="plan_edit.aspx.cs" Inherits="admin_plan_edit" %>
    ...
    <form id="form1" runat="server">
        <div class="body1">
            ...
            <div class="body1-rigth">
                <div class="header">
                    <span class="header-left-title">项目计划>编辑</span>
                    <div class="right">
                ...
                <div class="wrap">
                    <div class="input-item">
                        ...
                        <asp:TextBox ID="work_itemid" runat="server"></asp:TextBox>
                    </div>
                    <div class="input-item">
                        <asp:Label ID="Label1" runat="server" Text="任务id"></asp:Label>
                        <asp:TextBox ID="work_workid" runat="server"></asp:TextBox>
                    </div>
                    <div class="input-item">
                        <asp:Label ID="Label4" runat="server" Text="任务人员"></asp:Label>
                        <asp:DropDownList ID="work_userid" runat="server">
                    ...
                    <div class="input-item">
                        <asp:Label ID="Label2" runat="server" Text="任务简介"></asp:Label>
                        <asp:TextBox ID="work_memo" runat="server"></asp:TextBox>
                    </div>
                    <div class="input-item">
                        <asp:Label ID="Label6" runat="server" Text="开始日期"></asp:Label>
                        <asp:TextBox ID="work_sdate" runat="server"></asp:TextBox>
                    </div>
                    <div class="input-item">
                        <asp:Label ID="Label7" runat="server" Text="提交日期"></asp:Label>
                        <asp:TextBox ID="work_edate" runat="server"></asp:TextBox>
                    </div>
                    <div class="input-item">
                        <asp:Label ID="Label9" runat="server" Text="任务状态"></asp:Label>
                    ...
                    <div class="input-item">
                        <asp:Label ID="Label10" runat="server" Text="优先级"></asp:Label>
                        <asp:DropDownList ID="work_priority" runat="server">
                            <asp:ListItem>严重-3</asp:ListItem>
                            <asp:ListItem>重要-2</asp:ListItem>
                            <asp:ListItem>一般-1</asp:ListItem>
                        </asp:DropDownList>
                    </div>
